...
appearance_counts = filtered_df['Limb Appearance'].value_counts() if 'Limb Appearance' in filtered_df.columns else pd.Series(dtype=float)

# Triggers on high‑pain days
...
if not high_pain_days.empty:
    for _, row in high_pain_days.iterrows():
